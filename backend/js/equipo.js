  $(function () {
    ...
    $('#registros').on('submit', function(event){
     ...
     if($('#registros').parsley().isValid())
     {
       ...
       if (Tab == 0) {
          var vurl = "backend/datos/controller/equipoController.php";

       }else if (Tab == 1){
          var vurl = "../../datos/controller/equipoController.php";
       }else{
          var vurl = "../../datos/controller/equipoController.php";
       }
    ...
    $('#uploadForm').on('submit', function(event){
     ...
     {
       var vData = new FormData(document.getElementById("uploadForm"));

      var vurl = "../../datos/controller/resultadosController.php";
    ...
    if(vId != 0){
      ...
      .done(function(data){
        if (data.success) {
          ...
          $('#de').html(data.Detalle);
          $('#FechaR').html(data.Created_date);
          $('#FechaU').html(data.Updated_date);
          $('#FT').empty();
          $('#FT').append('<img src="../../datos/'+data.Foto+'" width="90px">');
...
$("#NuevoRegistro22").click(function(){
    $("#registros")[0].reset();
