  ...
  function VerUsuario(Id){
    ...
    var vurl = "../../datos/controller/textosController.php";
    ...
    if(vId != 0){
      ...
      .done(function(data){
        if (data.success) {
          ...
          $('#st').html(data.Status);
          $('#st2').html(data.Id);
          $('#nombre').html(data.Texto);
          $('#Email').html(data.Pagina);
          $('#I1').append(vimg);
    ...
    if(vId != 0){
      ...
      .done(function(data){
        if (data.success) {
          ...
          $('#txtSubup').val(data.Sub);
          $('#txtTextup').val(data.Texto);
  ...
  $('#usuariosup').on('submit', function(event){
    ...
    if($('#usuariosup').parsley().isValid())
    {
      ...
      if (Tab == 0) {
         var vurl = "backend/datos/controller/textosController.php";
