          ...
          <form id="Imagen"  role="form" data-parsley-validate="" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <div class="form-group has-feedback">
              <select name="txtTipo" id="txtTipo" class="form-control" required="" data-parsley-trigger="keyup"   data-parsley-required-message="Campo requerido">
                  ...
                  <option value="Home Resorts">Home Resorts</option>
                  <option value="Home Galeria Resorts">Home Galeria Resorts</option>
                  <option value="Home Slide Resorts">Home Slide Resorts</option>
                  <option value="Logo Color">Logo Color</option>
                  <option value="Logo Blanco">Logo Blanco</option>
                  <option value="Resorts">Resorts</option>
                  <option value="Cruceros">Cruceros</option>
                  <option value="Tours">Tours</option>
                  <option value="Villas">Villas</option>
                  <option value="Nosotros">Nosotros</option>
                  <option value="Slide Nosotros">Slide Nosotros</option>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="usuariosup"  role="form" data-parsley-validate="" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <div id="ImaS"></div>
              <label for="">Imagen Secundaria opcional</label> 
              <input type="file" class="form-control" placeholder="Programa de interes" name="txtImgSup" id="txtImgSup">
              <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
