  ...
  <section class="container-fluid b-w" id="sectionPrincipalOfertas">
    ...
    <!-- <div class="container">
        ...
        <div class="row serv1">
            ...
            <div class="col-xs-12 col-sm-3 col-md-3 text-center s">
                <img src="../front/images/ofertas/co1.jpeg" alt="" class="ofertas-co">
            </div>
            <div class="col-xs-12 col-sm-3 col-md-3 text-center s">
                <img src="../front/images/ofertas/co2.jpeg" alt="" class="ofertas-co">
            </div>
            <div class="col-xs-12 col-sm-3 col-md-3 text-center s">
                <img src="../front/images/ofertas/co3.jpeg" alt="" class="ofertas-co">
            </div>
            <div class="col-xs-12 col-sm-3 col-md-3 text-center s">
                <img src="../front/images/ofertas/co4.jpeg" alt="" class="ofertas-co">
            </div>
        </div>

        <div class="row serv1 ">
            <div class="col-xs-12 col-sm-3 col-md-3 text-center s">
                <img src="../front/images/ofertas/co5.jpeg" alt="" class="ofertas-co">
            </div>
            <div class="col-xs-12 col-sm-3 col-md-3 text-center s">
                <img src="../front/images/ofertas/co7.jpeg" alt="" class="ofertas-co">
            </div>
            <div class="col-xs-12 col-sm-3 col-md-3 text-center s">
                <img src="../front/images/ofertas/co8.jpeg" alt="" class="ofertas-co">
            </div>
            <div class="col-xs-12 col-sm-3 col-md-3 text-center s">
                <img src="../front/images/ofertas/co9.jpeg" alt="" class="ofertas-co">
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <h1 class="title-main text-center p-5" id="title-contact">ALQUILER DE SALAS: SALAS REUNIONES 30€ <br>
                    PUESTOS FIJOS O FLEXIBLES DESDE 50€ /MES</h1>       
        </div>
        <div class="row serv">
    ...
    <div class="row puesto pt-5">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 oferta2">
