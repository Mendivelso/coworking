  ...
  <div class="login-box-body">
    ...
    <form id="FormLogin" data-parsley-validate="">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Email" required="" data-parsley-required-message="Ingrese su Usuario" name="txtUser" id="txtUser">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Password" required="" data-parsley-required-message="Ingrese su Contrasena" name="txtPass" id="txtPass">
    ...
    <a href="recuperar_contrasena.php">I forgot my password</a><br>
