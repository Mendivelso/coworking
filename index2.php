...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
  ...
  <section class="container-fluid b-w" id="sectionPrincipal">
    <div class="row frase">
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 npdd fondo-recepcion">
        ...
        <ol class="carousel-indicators">
          ...
          <div class="carousel-inner">
            <div class="item active item1">
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum, ea aliquid beatae, tenetur impedit nobis aspernatur officia veritatis ab <br>
                 incidunt provident ex, minus ut molestiae eos molestias fugiat repudiandae alias.  Lorem ipsum dolor, sit amet consectetur adipisicing elit. <br>
                  Minus aperiam cupiditate, aspernatur provident reprehenderit deleniti nulla! Unde harum sapiente quia, amet error minima ipsa fuga rem quas qui ducimus. Pariatur.
              </p>
            </div>
